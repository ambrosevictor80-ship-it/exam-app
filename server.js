...
// ========================================
// REAL QUESTIONS - PHYSICS (Easy only for now)
// ========================================
...
// ========================================
// REAL QUESTIONS - BIOLOGY (Easy only for now)
// ========================================
...
// ========================================
// REAL QUESTIONS - CHEMISTRY (Easy only for now)
// ========================================
...
// ========================================
// REAL QUESTIONS - COMPUTER SCIENCE (Easy only for now)
// ========================================
...
console.log(`   Physics: Easy ${physicsQuestions.easy.length}`);
console.log(`   Biology: Easy ${biologyQuestions.easy.length}`);
console.log(`   Chemistry: Easy ${chemistryQuestions.easy.length}`);
console.log(`   Computer Science: Easy ${computerScienceQuestions.easy.length}`);
